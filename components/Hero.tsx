...
const Hero = () => {
  return (
    <div className='relative pb-10 pt-20'>
      ...
      {/* Background and Mask */}
      <div className="relative flex items-center justify-center h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.05] bg-grid-black/[0.2]">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none dark:bg-black-100 bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_30%,black)]" />
        
        {/* Image in the right corner */}
        <div className='absolute top-2/3 right-4 transform -translate-y-1/2'>
          <div className='relative w-32 h-32 md:w-48 md:h-48 lg:w-64 lg:h-64'>
            <img
              src="/Ayele_Gobezie.jpg"
              alt="Ayele Gobezie Chekol"
              className='rounded-full shadow-lg object-contain w-full h-full'
            />
          </div>
          {/* Name and Degree Below the Photo */}
          <div className='relative top-4 mt-6 px-2 text-center'>
            <p className='text-gray-900 dark:text-gray-100 text-lg md:text-xl lg:text-2xl font-extrabold leading-tight'>
      ...
      <div className='relative z-20 flex flex-col items-center justify-center my-20'>
        <div className='flex flex-col items-center text-center max-w-[60vw] md:max-w-2xl lg:max-w-3xl'>
          ...
          <p className='mt-4 text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300'>
